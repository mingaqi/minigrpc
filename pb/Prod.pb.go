...
type ProdRequest struct {
	...
	ProdId int32 `protobuf:"varint,1,opt,name=prod_id,json=prodId,proto3" json:"prod_id,omitempty"` // 传入商品ID
}
...
type ProdResponse struct {
	...
	ProdStock int32 `protobuf:"varint,3,opt,name=prod_stock,json=prodStock,proto3" json:"prod_stock,omitempty"` //商品库存
}
...
var file_Prod_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x64, 0x53, 0x74,
